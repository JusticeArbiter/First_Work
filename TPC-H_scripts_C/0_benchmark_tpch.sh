...
export DBNAME=tpch_30g
export USER=highgo
export PGPORT=5678
export TPCH_LOG=/home/sevengod/tpch_log/30g
export STREAMS=5      #the real streams is: 4 ($STREAMS -1) ,the 1 use for power test.
export SF=30          #the SF scope is [1 10 30 100 300 1000 3000 10000]
